    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_center,_#1f2124_0%,_#131517_100%)] text-white font-sans flex flex-col justify-between selection:bg-white selection:text-black">
      ...
      <header className="flex justify-between items-center px-6 py-4 md:px-12 md:py-6 border-b border-white/[0.03]">
        ...
        <div className="flex items-center gap-6 text-sm text-white/60">
          ...
          <Link to="/login" className="bg-white/[0.08] hover:bg-white/[0.12] text-white border border-white/[0.08] rounded-full px-4 py-1.5 font-medium transition-all text-xs">
            Sign In
          </Link>
        </div>
      </header>
          ...
          {isSuccess ? (
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      type="button"
                      onClick={() => alert("Mobile registration is coming soon!")}
              ...
              <div className="space-y-3">
                <button
                  type="button"
                  onClick={() => alert("Google signup is currently unavailable.")}
